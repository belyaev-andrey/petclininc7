...
@injectMainStore
@observer
class ConsumableEditComponent extends React.Component<
  Props & WrappedComponentProps
> {
  dataInstance = instance<Consumable>(Consumable.NAME, {
    view: "_local",
  ...
  isNewEntity = () => {
    return this.props.entityId === ConsumableManagement.NEW_SUBPATH;
  };

  render() {
    if (this.updated) {
      return <Redirect to={ConsumableManagement.PATH} />;
    }
      ...
      <Card className="narrow-layout">
        <Form onSubmit={this.handleSubmit} layout="vertical" ref={this.formRef}>
          ...
          <Form.Item style={{ textAlign: "center" }}>
            <Link to={ConsumableManagement.PATH}>
  ...
  componentDidMount() {
    if (this.isNewEntity()) {
      this.dataInstance.setItem(new Consumable());
    } else {
