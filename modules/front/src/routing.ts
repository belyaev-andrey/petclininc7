import { ConsumableManagement } from "./app/consumable/ConsumableManagement";
...
menuItems.push({
  pathPattern: "/consumableManagement/:entityId?",
  menuLink: "/consumableManagement",
  component: ConsumableManagement,
  caption: "ConsumableManagement"
});
